...
export default function AboutPage() {
  return (
    <>
      {/* ✅ SEO Section */}
      <Head>
        <title>About Planvera | Best Abroad Consultancy in Guntur</title>
        <meta
          name="description"
          content="Meet the expert team at Planvera, trusted best abroad consultancy in Guntur. Learn how we help students achieve global success."
        />
        <meta
          name="keywords"
          content="best abroad consultancy in guntur, about abroad consultancy Guntur, expert education counselors Guntur, Guntur overseas consultancy, best study abroad team Guntur"
        />
        <meta property="og:title" content="About Planvera | Best Abroad Consultancy in Guntur" />
        <meta
          property="og:description"
          content="Meet the expert team at Planvera, trusted best abroad consultancy in Guntur. Learn how we help students achieve global success."
        />
        <meta property="og:image" content="/v9j8_ky1g_211101.jpg" />
      ...
      <div className="bg-white text-black px-4 sm:px-6 md:px-16 py-12 space-y-20">
        ...
        >
          <div className="md:w-1/2 space-y-6 text-center md:text-left">
            ...
            <p className="text-base sm:text-lg">
              Planvera is a premier <strong>overseas education consultancy in Guntur</strong> dedicated to guiding students in their journey to study abroad. We specialize in helping students choose the right country, university, and program that fits their academic goals and career ambitions.
            </p>
            <p className="text-base sm:text-lg">
          ...
          <div className="md:w-1/2 w-full">
            <Image
              ...
              alt="Our team - Planvera Overseas Consultancy Guntur"
              width={600}
              height={400}
        ...
        >
          <Image
            ...
            alt="Student Success Stories - Planvera"
            width={600}
            height={400}
