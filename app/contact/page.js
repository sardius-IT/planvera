...
import Head from "next/head"; // ✅ For client-side SEO
...
export default function ContactForm() {
  ...
  return (
    <>
      ...
      <Head>
        <title>Overseas Education Experts in Guntur | Planvera Consultancy</title>
        <meta
          name="description"
          content="Contact Planvera, Guntur’s expert education consultancy, for personalized overseas study counseling. Start your application today!"
        />
        <meta
          name="keywords"
          content="overseas education experts Guntur, contact abroad consultancy Guntur, education consultancy contact Guntur, best consultancy near me, Planvera Guntur contact"
        />
        <meta property="og:title" content="Overseas Education Experts in Guntur | Planvera Consultancy" />
        <meta
